...
def trafficDataIngestion(datalimit, start_datetime, end_datetime, file_dir):
    ...
    date = f"data_as_of >'{start_datetime}'"  #para a partir de una fecha
...
trafficDataIngestion(10, "2021-02-01T00:00:00", "2021-02-28T23:59:59", "borrame.csv")
